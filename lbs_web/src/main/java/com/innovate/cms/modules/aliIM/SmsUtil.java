...
public class SmsUtil {
	...
	static {
		...
		IClientProfile profile = DefaultProfile.getProfile("cn-bejing", accessKeyId, accessKeySecret);
		try {
			DefaultProfile.addEndpoint("cn-bejing", "cn-bejing", product, domain);
	...
	public static SendSmsResponse sendVerifyCode(String code, String mobile) throws ClientException {
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
		...
		// 必填-号码
		request.setPhoneNumber("13552846664");
		// 可选-流水号
