 ...
 * @date 2016年8月10日
 */
public class QxFootprintWithPraiseAndComment implements Serializable {
	...
	public QxFootprintWithPraiseAndComment() {
		super();
	}

	public QxFootprintWithPraiseAndComment(Integer footid, String uid, String footName, String footImg, String footType,
