...
public class UserInfoToJson implements Serializable
{
	...
	public UserInfoToJson(String uid, String unionid, String nickname, String sex, String constellation, Date birthday,
			String province, String city, String country, String headimgurl, String userGroups, String userType)
	{
		super();
		this.uid = uid;
